...
export function ConfirmSignInCodeForm({ className, onSubmit, resetOnSuccess = true, disabled }: ConfirmSignInCodeFormProps) {
  ...
  const handleSubmit = form.handleSubmit(async (values: ConfirmSignInCodeFormSchema) => {
    try {
