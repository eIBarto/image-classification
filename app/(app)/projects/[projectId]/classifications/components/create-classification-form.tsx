...
export type CreateClassificationFormSchema = z.infer<typeof formSchema>;

export interface CreateClassificationFormProps extends Pick<React.ComponentProps<"form">, "className"> {
  onSubmit?: (values: CreateClassificationFormSchema) => Promise<void | string> | void
  resetOnSuccess?: boolean
  disabled?: boolean
  projectId: string
}

export function CreateClassificationForm({ className, onSubmit, resetOnSuccess = true, projectId, ...props }: CreateClassificationFormProps) {
  const form = useForm<CreateClassificationFormSchema>({
  ...
  const handleSubmit = form.handleSubmit(async (values: CreateClassificationFormSchema) => {
    try {
